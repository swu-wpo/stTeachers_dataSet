...
if __name__ == '__main__':
    ...
    appid = "c2d804e7"
    apikey = "95f2c009239a0953aa1c225d1ef4f53c"
    apisecret = "YzFiMWQ0ZTVlMWIwNzhiMGVkNTYxNDUw"

    audioPath = r"../../rawData/audio"  # 音频文件夹 需要修改为自己的
    # audioPathList = os.listdir(audioPath)
    # audioPathList.sort()  # 对读取的路径进行排序
    # for filename in audioPathList:
    #     if filename.endswith(".mp3"):
    #         # 输入自己的id和key
    #         api = RequestApi(appid="c2d804e7", secret_key="YzFiMWQ0ZTVlMWIwNzhiMGVkNTYxNDUw",
    #                          upload_file_path=audioPath + "/" + filename)
    #         api.all_api_request()

    file_path = audioPath + "/" + "audio_sample_little.wav"
